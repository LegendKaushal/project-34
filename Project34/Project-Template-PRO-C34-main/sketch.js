...
function setup() {
  ...
  box7 = new Box(675, 100, 70, 70);
  box8 = new Box(675, 100, 70, 70);
  box9 = new Box(675, 100, 70, 70);
  box10 = new Box(675, 100, 70, 70);
  box11 = new Box(675, 100, 70, 70);
  box12 = new Box(750, 100, 70, 70);
  box13 = new Box(750, 100, 70, 70);
  box14 = new Box(750, 100, 70, 70);
  box15 = new Box(750, 100, 70, 70);
  box16 = new Box(825, 100, 70, 70);
  box17 = new Box(825, 100, 70, 70);
  box18 = new Box(825, 100, 70, 70);
  box19 = new Box(825, 100, 70, 70);
